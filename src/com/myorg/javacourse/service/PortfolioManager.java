...
public class PortfolioManager implements PortfolioManagerInterface {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.algo.service.PortfolioManagerInterface#getPortfolio()
	 */
	...
	public void update() {
		...
		int portfolioMaxSize = ((Portfolio) getPortfolio())
				.getMAX_PROTFOLIO_SIZE();// to check if maxSize can be static
		List<String> symbols = new ArrayList<>(portfolioMaxSize);
		for (StockInterface si : stocks) {
			symbols.add(si.getSymbol());
		}

		List<Stock> update = new ArrayList<>(portfolioMaxSize);
	 ...
	 *
	 * @return the portfolio total status
	 */
	@Override
	...
	private Stock fromDto(StockDto stockDto) {
		...
		if (stockDto.getRecommendation() != null)
			newStock.setRecommendation(ALGO_RECOMMENDATION.valueOf(stockDto
					.getRecommendation()));
	...
	/**
	 * A method that returns a new instance of Portfolio copied from another
	 * instance.
	 * 
	 * @param portfolio
	 *            Portfolio to copy.
	 ...
	 * 
	 * @see
	 * org.algo.service.PortfolioManagerInterface#setTitle(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.algo.service.PortfolioManagerInterface#updateBalance(float)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.algo.service.PortfolioManagerInterface#sellStock(java.lang.String,
	 * int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.algo.service.PortfolioManagerInterface#removeStock(java.lang.String)
	 */
	@Override
